...
# Unpacking Schmachtenberger's War on Sensemaking
...
The reason to be good sensemakers is to understand (1) how and (2) why the truth is often distorted (1) unintentionally or (2) on purpose.

Knowing the truth (as much a possible) will help us make more meaningful decisions for ourselves, our families and friends, sociocultural and economic communities, our countries, the ecosystem, etc.
...
This write-up introduces my main takeaways from the first episode in the series. I tried to thematically organize my initial notes for a clear narrative that introduces, analyses and provides a solution to the problem linked to information warfare.[^amended]

[^amended]: I extended my initial notes with additional research and personal examples. I plan to review the other episodes in the series to extend this write-up.

### Problem: Information Ecology and Warfare
The concepts of a broken information ecology and information warfare are introduced as a problem, highlighting our challenge of recognizing truth in a landscape where information may be distorted or manipulated for various purposes. Daniel encourages us to be skeptical towards
   ...
   2. **academia**, suggesting that sometimes there is a conflict of interest and cherry picking of data.

### Analysis: Truthfulness vs. Representativeness
...
### Solution: Epistemology and Better Sensemaking
...
- religious influence in politics (e.g. linked to [abortion](https://www.npr.org/2022/05/14/1098800437/religion-role-politics), [conservatism in general](https://www.youtube.com/watch?v=Upa2Rk_Y1Z0))
...
[Comparing news](https://www.ecosia.org/search?tt=e8eb07a6&q=compare%20news&addon=brave) can help see the same truth from different political perspectives. 

The two main perspectives could be found in what the [core believes of the political left and right (used to be)](https://youtu.be/7LqaotiGWjQ?si=SiWKFLK1bTgUjRI4&t=5160) or [is it more complicated](https://youtu.be/jJEuZrvNYg0?si=XU7iCrbnMc3MAiHG)?[^goodintheorypod] <!-- Are these perspectives linked to the jin/jang? -->
...
Why?
1. corporate funding of research
...
2. just want to get papers published to be able to apply for funding 

Moree from Andy Stapleton: 
...
So, we proxy our sensemaking i.e. we form our understanding using the summaries and opinion of people we trust. 
...
Also, consider how your sensemaking is 'guided' by e.g. by typography, tone, choice of words, additional music (compare Lee vs Norris [here](https://www.youtube.com/watch?v=FUfuZJI9LK4) and [there](https://youtu.be/16Jy-K0kjbE?si=zhJlV8rMnGHuZ-U7))<!-- Find examples on YouTube with real news where music is sensational.-->.

Attention and clear (objective) thinking requires training. Like a muscle, it needs to be stressed e.g. by studying, doing your own research. <!-- Picture of body building and new neural pathways developing. -->

![Old women reading, painting.](/assets/img/vanRijn1631OldWomenReading.jpg)

The good news is that sensemaking is developable. 

The bad news is that people in general don't care about developing it because (1) they already decided what to believe in or (2) gave up on trying to understand the world. 

Why don't we care about developing our sensemaking?

Most people can't hold the cognitive complexity of base reality and still make a living i.e. we don't have time and energy to do good sensemaking. Unfortunately, Daniel says, "giving up on sensemaking is kind of an expression of a type of nihilism [which] feeds into further nihilism". <!-- #personal Why did I give up checking the news? I needed time to concentrate what was in front of me; PhD, work, family, health. -->

When truth (base reality) is communicated, it can be 

1. representative (simple representation of the truth)
2. truthful (the sender believes it is true, but it is distorted)
3. manipulative <!-- Is this a good term to describe this? -->

![Bringing in the Trojan Horse etching.](/assets/img/Mignon1545TrojanHouse.jpg)

Keep in mind that (1) withholding information and (2) the receivers perception of the signal (through their biases) can also lead to distortion. <!-- Find example using an analogue/digital communication protocols which then can be linked back to week 1's lecture? -->

### 3.2 Why is the truth distorted?
Distorting information is not human, animals and plants dot it to. <!-- What are the best examples here? -->
...
Exponential technology can misinform exponentially. <!-- How is social media and AI linked to this?  -->

A detailed study on the The evolution of deception can be found [here](https://royalsocietypublishing.org/doi/10.1098/rsos.201032). 

We distort base reality i.e. lie for different reasons e.g. there is a difference between a company hiding its pollution, someone writing good comments on his friend's bad essay, tricking others in poker or football game or laying to children about Santa. <!-- We could also lie to people because we think they wouldn't understand the truth. What other examples can we make here? -->

Compare how are [deepfakes is used in politics](https://youtu.be/wxEpPin8MWw?si=a-ZIem7gMMFxjo8D). 
...
Governments, businesses, people use game theory to compete with each other. 

He talks about genetics and memetics in relation to how people adapt and mutate information: 

Example (religion): Jesus' key message was forgiveness, even though he was crucified. But Christianity, in Jesus' name went on crusades and tortured people through the inquisition. 

A religious example of distorting truth: 

![Jesus on the cross, painting.](../assets/img/Tissot1894CrossJesus.jpg)

> Father, forgive them, for they do not know what they are doing. 
 
![In a basement vault, torture is carried out by the Inquisition.](../assets/img/Philips1775Inquisition.jpg)
...
He says, true understanding (of base reality) is complex and therefore difficult to advertise. People don't want to (or can't) spend much time on 'real thinking', so 'simpler' versions of truth can spread easier. 'Simulated thinking' <!-- Where does this term come from? --> requires less processing, is often reassuring (as its source is the in-group, the echo chamber) and can be exciting as well. 

### 3.3 In-groups and out-groups
Later Daniel talks about in-groups and out-groups and how they use propagator and protector memes in the memetic ecosystems. <!-- This is important so let's define them. --> 

An example of a protector meme: "Faith is good, doubt [critical thinking] is bad."

The problem is partiality of our perspective; we often belong to an in-group and are informed in that group's echo-chambers. 

Why? Leaving the group is uncomfortable, maybe even scary. 

## 4. Solution: Epistemology and Better Sensemaking
<!-- Define epistemology and how it links to critical thinking and ontology. -->

Reality is complex, so what tools, metrics can help our sensemaking? Practice epistemology with a group of people you trust. 

In order to heal our information ecology we need 
1. seek to understand before to be understood
2. feel the importance to understand base reality (despite the pull of nihilism)
3. understand that it is very complex (that there can be multiple perspectives) and that there is always more to learn (we should be humble and practice humility).

To become better at sensemaking when we perceive information, we need try understand 
1. why the sender is sending (e.g. to understand the reasons for a potential distortion)
2. how much distortion is happening
3. all perspectives and find their common grounds (thesis + antithesis = synthesis). <!-- Link this to analysis/synthesis in research methodology? Also how can then synthesis be linked to 'creativity' to creating something novel? And then that if something is new for us (e.g. a new understanding) that is still very important even if it is not new for other people (e.g. they understood it last year or when they first had a child). --> This is where he can gain a higher order clarity. <!-- Link to Flatland. -->
4. our own biases 
6. what holds you back when engaging with the your antithesis, with the perspectives you think are distorted
7. where we can practice this kind of sensemaking in groups (where we can be honest about how much we don't know and about our doubts).
...
## Tasks
1. extend organized notes with examples and figures
2. extend notes with sensemaking 2–4 ... video analysis
3. extend notes with a classification of forms of political government, the history of their evolution and how their perspectives can be linked to sensemaking

## Log
2023-03-19/20 I refined the narrative of the write-up and looked at adjusting it for an oral presentation. 
